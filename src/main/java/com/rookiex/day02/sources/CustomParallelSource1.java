 ...
 */
public class CustomParallelSource1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<Integer> lines = env.addSource(new MyParallelSource1());
    ...
    //多并行的Source，因为实现了ParallelSourceFunction
    // 即调用完Source后得到的DataStream中对应的数据类型
    private static class MyParallelSource1 implements ParallelSourceFunction<Integer> {

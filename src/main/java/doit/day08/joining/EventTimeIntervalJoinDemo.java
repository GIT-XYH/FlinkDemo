...
public class EventTimeIntervalJoinDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple5<String, String, String, Double, Integer>> joined = orderDetailStream.keyBy(t -> t.f0)
                .intervalJoin(orderMainStream.keyBy(t -> t.f0))
                .between(Time.seconds(-1), Time.seconds(1))
                .upperBoundExclusive() //[-1,1)
                .process(new ProcessJoinFunction<Tuple4<String, String, Double, Integer>, Tuple3<String, Double, String>, Tuple5<String, String, String, Double, Integer>>() {

                    @Override
                    public void processElement(Tuple4<String, String, Double, Integer> left, Tuple3<String, Double, String> right, Context ctx, Collector<Tuple5<String, String, String, Double, Integer>> out) throws Exception {
                        out.collect(Tuple5.of(left.f0, right.f2, left.f1, left.f2, left.f3));
                    }
                });
